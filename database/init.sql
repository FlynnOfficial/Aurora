...
-- BCrypt Hash (12 rounds): $2a$12$R0h.uKvDNxQXvW/KI8eDl.m.HT6TYFbEGXTG1lDHGf5N6d5nJGqt2
-- ============================================
...
-- Inserir Admin
-- Password: admin123
-- BCrypt Hash (12 rounds): $2a$12$yDcXs/r8g4X6N1n5z8Y3H.K5lPq2M0o9B3c4D5e6F7g8H9i0J1k2
-- ============================================
INSERT INTO users (email, password, name, role, active, last_login, failed_attempts)
VALUES (
...
-- Inserir Teachers
-- Password: prof123
-- BCrypt Hash (12 rounds): $2a$12$7F8g9H0i1J2k3L4m5N6o7P8q9R0s1T2u3V4w5X6y7Z8a9B0c1D2e3
-- ============================================
INSERT INTO users (email, password, name, role, active, last_login, failed_attempts)
VALUES (
...
-- Inserir Students
-- Password: aluno123
-- BCrypt Hash (12 rounds): $2a$12$5C9b8K2x3L1m4n5O6p7Q8r9S0t1U2v3W4x5Y6z7A8b9C0d1E2f3
-- ============================================
INSERT INTO users (email, password, name, role, active, last_login, failed_attempts)
VALUES (
